...
- 광고 등급: 중상
- 프로젝트 폴더: `tic_tac_toe`
- `pubspec` 이름: `tic_tac_toe`
- Android 패키지: `com.dangundad.tictactoe`
- 버전: `1.0.0+1`
- 핵심 기능: 틱택토/오목, Minimax AI (3난이도), 2P 로컬, 승패 통계
...
## 빠른 명령어
```bash
cd C:\Flutter_WorkSpace\tic_tac_toe
flutter pub get
...
- `data/models`: 없음
- `data/enums`: `ai_difficulty.dart`, `game_mode.dart`, `game_status.dart`, `game_type.dart`
- `data/constants`: 없음
- `data` 루트 파일: 없음
- `assets`: `data`, `fonts`, `images`
- `tests`: 2개: `test/app/services/app_rating_service_test.dart`, `test/widget_test.dart`
